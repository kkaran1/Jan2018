...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    <br /> <br />
    <div class="row">
        <asp:Label ID="Label1" runat="server" Text="Enter Artist Name (patial)"></asp:Label>&nbsp;&nbsp;
    ...
    <br />
    <div class="row">
        <asp:GridView ID="ArtistNameGVList" runat="server" DataSourceID="ArtistNameODS" AutoGenerateColumns="False" AllowPaging="True">
            <Columns>
                <asp:BoundField DataField="AlbumId" HeaderText="Album" SortExpression="AlbumId">
                    <HeaderStyle HorizontalAlign="Center" BackColor="#999999" BorderColor="Red" BorderWidth="5px" ForeColor="#0000CC"></HeaderStyle>
            ...
            <EmptyDataTemplate>
                Nothing To Display for the current Artist Name.
            </EmptyDataTemplate>
        </asp:GridView>
    </div>
                    ...
                    <td runat="server">
                        <table runat="server" id="itemPlaceholderContainer" style="background-color: #FFFFFF; border-collapse: collapse; border-color: #999999; border-style: none; border-width: 1px; font-family: Verdana, Arial, Helvetica, sans-serif;" border="1">
                            <tr runat="server" style="background-color: #DCDCDC; color: #000000;">
                                ...
                                <th runat="server">eLabel</th>
                               <%-- <th runat="server">Artist  (This is a Navigational Property)</th>--%>
                            </tr>
